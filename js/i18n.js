...
const I18N_STRINGS = {
  ...
  "toast.classlocked": { id: "Ada sesi kelas aktif - aktivitas yang disarankan guru ditandai di menu.", en: "A class session is active - your teacher's suggested activity is marked in the menu." },
  "classsession.activitychanged": { id: "Guru mengganti aktivitas kelas. Klik \"Ke sana sekarang\" kalau mau ikut, atau lanjutkan belajarmu.", en: "Your teacher changed the class activity. Click \"Go there now\" to follow, or keep working on your own." },
  ...
  "eksdata.avgsuffix": { id: "rata-rata", en: "mean" },
  "eksdata.needI": { id: "Isi kolom {{label}} pada setiap baris yang datanya sudah kamu tulis.", en: "Fill in the {{label}} column for every row where you entered data." },
  "lkpd.mode.title": { id: "Pilih jenis praktikum", en: "Choose your practical" },
  "lkpd.mode.note": { id: "Data dan jawaban tiap jenis praktikum disimpan terpisah di perangkat ini, jadi kamu bisa berpindah tanpa kehilangan pekerjaan.", en: "Data and answers for each type are stored separately on this device, so you can switch without losing your work." },
  "lkpd.progress.done": { id: "Kelengkapan LKPD: {{pct}}%", en: "Worksheet completion: {{pct}}%" },
  "lkpd.progress.score": { id: "Skor soal: {{ok}}/{{total}} benar", en: "Question score: {{ok}}/{{total}} correct" },
  "lkpd.check": { id: "Cek Jawaban", en: "Check Answer" },
  "lkpd.hint": { id: "Petunjuk", en: "Hint" },
  "lkpd.enrich": { id: "Pengayaan", en: "Enrichment" },
  "lkpd.pick": { id: "Pilih satu jawaban dulu.", en: "Pick an answer first." },
  "lkpd.correct": { id: "Benar!", en: "Correct!" },
  "lkpd.wrong.letter": { id: "Belum tepat. Jawaban yang benar: {{letter}}.", en: "Not quite. The correct answer is {{letter}}." },
  "lkpd.calc.placeholder": { id: "hasil B", en: "your B" },
  "lkpd.calc.needvalue": { id: "Tulis angka jawabanmu dulu.", en: "Enter your numerical answer first." },
  "lkpd.needdata": { id: "Lengkapi dulu tabel data (minimal 2 baris) dan ukuran alat (L dan N) supaya jawabanmu bisa dicek dengan grafikmu.", en: "First complete the data table (at least 2 rows) and the measurements (L and N) so your answer can be checked against your graph." },
  "lkpd.calc.right": { id: "Benar! Dari grafikmu B ≈ {{val}} T.", en: "Correct! From your graph B ≈ {{val}} T." },
  "lkpd.calc.wrong": { id: "Belum tepat. Dari gradien grafikmu B ≈ {{val}} T. Periksa satuan (cm ke m) dan nilai N.", en: "Not quite. From your graph gradient B ≈ {{val}} T. Check the units (cm to m) and the value of N." },
  "lkpd.open.placeholder": { id: "Tulis jawabanmu di sini (tersimpan otomatis).", en: "Write your answer here (saved automatically)." },
  "lkpd.model.show": { id: "Lihat / sembunyikan contoh jawaban", en: "Show / hide sample answer" },
  "lkpd.model.title": { id: "Contoh jawaban:", en: "Sample answer:" },
  "lkpd.kits.title": { id: "Contoh kit yang bisa dibeli", en: "Example kits you can buy" },
  "lkpd.graph.aria": { id: "Grafik gaya F terhadap arus I beserta garis terbaik", en: "Graph of force F against current I with line of best fit" },
  "lkpd.graph.empty": { id: "Isi minimal 2 baris data (I dan Δm) pada tabel untuk melihat grafik.", en: "Fill in at least 2 rows of data (I and Δm) in the table to see the graph." },
  "lkpd.graph.gradient": { id: "Garis terbaik: F = {{m}} · I {{sign}} {{c}} (R² = {{r2}}). Gradien = {{m}} N/A (= T·m).", en: "Best-fit line: F = {{m}} · I {{sign}} {{c}} (R² = {{r2}}). Gradient = {{m}} N/A (= T·m)." },
  "lkpd.graph.b": { id: "Rapat fluks magnetik dari gradien: B = {{b}} T", en: "Magnetic flux density from the gradient: B = {{b}} T" },
  "lkpd.graph.plausible": { id: "B berada dalam kisaran tipikal magnet praktikum ({{lo}} sampai {{hi}} T). Ini pengecekan kewajaran, bukan nilai mutlak.", en: "B lies in the typical range for practical magnets ({{lo}} to {{hi}} T). This is a sanity check, not an absolute value." },
  "lkpd.graph.implausible": { id: "B di luar kisaran tipikal ({{lo}} sampai {{hi}} T). Periksa satuan (g ke kg, cm ke m), jumlah lilitan N, dan pembacaan datamu.", en: "B is outside the typical range ({{lo}} to {{hi}} T). Check units (g to kg, cm to m), the number of turns N, and your readings." },
  "lkpd.graph.negslope": { id: "Gradien bernilai nol atau negatif: periksa arah arus dan tanda pembacaan Δm (dibuat positif).", en: "The gradient is zero or negative: check the current direction and the sign of Δm (make it positive)." },
  "lkpd.graph.needvars": { id: "Isi L (dan N) pada bagian Ukuran Alat untuk menghitung B.", en: "Fill in L (and N) in the Measurements section to calculate B." },
  "lkpd.summary": { id: "LKPD ({{mode}}): skor soal {{ok}}/{{total}}, kelengkapan {{pct}}%.", en: "Worksheet ({{mode}}): question score {{ok}}/{{total}}, completion {{pct}}%." },
  "lkpd.cell.aria": { id: "Isi sel ini", en: "Fill in this cell" },
  "question.check": { id: "Cek Jawaban", en: "Check Answer" },
  "question.answer.placeholder": { id: "Tulis jawabanmu di sini, lalu tekan Cek Jawaban untuk melihat pembahasan.", en: "Write your answer here, then press Check Answer to see the solution." },
  ...
  "settings.classsession.joined": { id: "Tergabung dalam sesi kelas - guru bisa mengarahkan aktivitas, tapi kamu tetap boleh maju sendiri lewat kuis 80%.", en: "Joined a class session - your teacher can point the activity, but you can still move ahead on your own by scoring 80% on the check." },
  ...
  "classsession.bannertext": { id: "Sesi kelas aktif - guru mengarahkan kelas ke: {{topic}} - {{tab}} sekarang.", en: "Class session active - your teacher is pointing the class to: {{topic}} - {{tab}} now." },
  ...
  "eksdata.sheeterror": { id: "Data tersimpan di perangkatmu, tetapi BELUM tertulis ke spreadsheet guru (ada masalah saat menulis). Kamu tetap boleh lanjut; coba klik Simpan Data lagi nanti, dan beri tahu gurumu bila tetap gagal.", en: "Your data is saved on this device, but has NOT been written to the teacher's spreadsheet (a write problem occurred). You can still continue; try Save Data again later and tell your teacher if it keeps failing." },
  "eksdata.staleBackend": { id: "Data tersimpan di perangkatmu, tetapi BELUM sampai ke spreadsheet guru: server (Apps Script) yang dipakai belum versi terbaru dan menjawab \"Prompt kosong.\". Kamu tetap boleh lanjut meminta persetujuan guru; beri tahu gurumu (redeploy Code.gs, atau kosongkan URL Backend lama di Pengaturan).", en: "Your data is saved on this device but has NOT reached the teacher's spreadsheet: the server (Apps Script) in use is not the latest version and answered \"Prompt kosong.\" (empty prompt). You can still continue and ask your teacher for approval; tell your teacher (redeploy Code.gs, or clear the old Backend URL in Settings)." },
  "eksdata.servererror": { id: "Data tersimpan di perangkatmu, tetapi server menolak penyimpanan ke spreadsheet ({{error}}). Kamu tetap boleh lanjut meminta persetujuan guru; beri tahu gurumu.", en: "Your data is saved on this device, but the server rejected saving to the spreadsheet ({{error}}). You can still continue and ask your teacher for approval; tell your teacher." },
  "gate.submit.failed": { id: "Permintaan persetujuan belum terkirim ke guru: {{error}}. Coba lagi, atau beri tahu gurumu.", en: "Your approval request was not delivered to the teacher: {{error}}. Try again, or tell your teacher." },
  ...
  "eksdata.networkerror": { id: "Gagal terhubung ke server. Datamu tetap tersimpan di perangkat dan kamu boleh lanjut; periksa koneksi internetmu lalu klik Simpan Data lagi nanti.", en: "Couldn't connect to the server. Your data stays saved on this device and you may continue; check your connection and click Save Data again later." },
  ...
  /* ---------------- Differentiated learning (tingkat belajar siswa) ---------------- */
  "level.dasar": { id: "Dasar", en: "Foundation" },
  "level.menengah": { id: "Menengah", en: "Core" },
  "level.lanjut": { id: "Lanjut", en: "Extension" },
  "teacher.th.level": { id: "Tingkat belajar", en: "Learning level" },
  "ability.label": { id: "Tingkat belajarmu:", en: "Your learning level:" },
  "ability.auto": { id: "otomatis, dari hasil kuis Materi", en: "automatic, from your Material check" },
  "ability.manual": { id: "dipilih sendiri", en: "chosen by you" },
  "ability.select.aria": { id: "Ubah tingkat belajar", en: "Change learning level" },
  "ability.select.auto": { id: "Otomatis (dari hasil kuis Materi)", en: "Automatic (from Material check)" },
  "ability.desc.dasar": { id: "Kamu dapat panduan langkah demi langkah, lembar rumus terbuka, soal latihan tambahan yang lebih bertahap, dan tutor yang menjelaskan dengan analogi sederhana.", en: "You get step-by-step guidance, an open formula sheet, more gradual extra practice, and a tutor that explains with simple analogies." },
  "ability.desc.menengah": { id: "Kamu dapat alur standar: lembar rumus (bisa dibuka), soal latihan tambahan setara ujian, dan tutor Socratic biasa.", en: "You get the standard flow: a formula sheet (expandable), exam-level extra practice, and the regular Socratic tutor." },
  "ability.desc.lanjut": { id: "Kamu dapat tantangan pengayaan: soal multi-langkah bergaya ujian, tugas prediksi di simulasi, dan tutor yang menuntut penalaran & pembenaran.", en: "You get enrichment challenges: multi-step exam-style questions, prediction tasks in the simulation, and a tutor that asks for reasoning and justification." },
  "diff.formula.title": { id: "Lembar rumus ringkas", en: "Quick formula sheet" },
  "diff.materi.dasar.title": { id: "Panduan Belajar (Tingkat Dasar)", en: "Study Guide (Foundation level)" },
  "diff.materi.dasar.s1": { id: "Baca satu bagian materi sekali waktu; catat setiap besaran beserta satuan SI-nya.", en: "Read one part of the material at a time; note every quantity with its SI unit." },
  "diff.materi.dasar.s2": { id: "Kalau bingung simbol, buka lembar rumus ringkas di bawah.", en: "If a symbol confuses you, open the quick formula sheet below." },
  "diff.materi.dasar.s3": { id: "Minta Tutor Fisika menjelaskan istilah yang belum paham dengan contoh sederhana.", en: "Ask the Physics Tutor to explain any term you don't understand with a simple example." },
  "diff.materi.dasar.s4": { id: "Setelah itu jawab kuis pemahaman. Boleh diulang sampai skormu minimal 80%.", en: "Then take the understanding check. You may retry until your score reaches at least 80%." },
  "diff.materi.dasar.tutorbtn": { id: "Minta Tutor: jelaskan konsep utamanya dengan contoh sederhana", en: "Ask the Tutor: explain the main idea with a simple example" },
  "diff.materi.dasar.tutormsg": { id: "Tolong jelaskan konsep utama topik ini dengan contoh sederhana dan analogi sehari-hari, satu langkah kecil dulu.", en: "Please explain the main idea of this topic with a simple example and an everyday analogy, one small step first." },
  "diff.materi.menengah.title": { id: "Referensi cepat", en: "Quick reference" },
  "diff.materi.lanjut.title": { id: "Tantangan Pengayaan (Tingkat Lanjut)", en: "Enrichment Challenge (Extension level)" },
  "diff.materi.lanjut.c1": { id: "Tutup materi, lalu jelaskan konsep utamanya dengan kata-katamu sendiri, termasuk satu kasus batas (nilai nol atau ekstrem).", en: "Close the material, then explain the main idea in your own words, including one limiting case (zero or extreme value)." },
  "diff.materi.lanjut.c2": { id: "Cek satuan rumus utama lewat analisis dimensi.", en: "Check the units of the main formula by dimensional analysis." },
  "diff.materi.lanjut.c3": { id: "Minta Tutor menguji penalaranmu dengan pertanyaan bergaya ujian Cambridge.", en: "Ask the Tutor to test your reasoning with a Cambridge exam-style question." },
  "diff.materi.lanjut.tutorbtn": { id: "Minta Tutor: beri aku pertanyaan tantangan", en: "Ask the Tutor: give me a challenge question" },
  "diff.materi.lanjut.tutormsg": { id: "Beri aku satu pertanyaan tantangan multi-langkah bergaya ujian Cambridge 9702 tentang topik ini. Jangan beri jawabannya dulu, minta aku membenarkan tiap langkah.", en: "Give me one multi-step Cambridge 9702 exam-style challenge question on this topic. Don't give the answer yet, make me justify each step." },
  "diff.latihan.dasar.title": { id: "Strategi mengerjakan soal (Tingkat Dasar)", en: "How to tackle a problem (Foundation level)" },
  "diff.latihan.dasar.s1": { id: "Tulis besaran yang diketahui beserta satuan SI-nya (ubah cm ke m, g ke kg, dst).", en: "Write down the known quantities with SI units (convert cm to m, g to kg, etc.)." },
  "diff.latihan.dasar.s2": { id: "Tulis besaran yang ditanyakan.", en: "Write down the quantity you are asked for." },
  "diff.latihan.dasar.s3": { id: "Pilih rumus dari lembar rumus yang memuat besaran-besaran itu.", en: "Pick the formula from the formula sheet that contains those quantities." },
  "diff.latihan.dasar.s4": { id: "Substitusikan angka, hitung, lalu tulis jawaban dengan satuannya.", en: "Substitute the numbers, calculate, then write the answer with its unit." },
  "diff.latihan.dasar.s5": { id: "Periksa: apakah nilainya masuk akal? Buka pembahasan HANYA setelah mencoba sendiri.", en: "Check: is the value sensible? Open the worked solution ONLY after trying it yourself." },
  "diff.latihan.menengah.title": { id: "Tips latihan", en: "Practice tip" },
  "diff.latihan.menengah.tip": { id: "Kerjakan dulu di kertas lengkap dengan satuan, baru cocokkan dengan pembahasan. Tandai langkah yang berbeda dari pembahasan.", en: "Work it out on paper with units first, then compare with the solution. Mark any step that differs from the worked solution." },
  "diff.latihan.lanjut.title": { id: "Tantangan Pengayaan (Tingkat Lanjut)", en: "Enrichment Challenge (Extension level)" },
  "diff.latihan.lanjut.c1": { id: "Sebelum membuka pembahasan, tulis jawaban lengkap dengan langkah, satuan, dan angka penting yang sesuai.", en: "Before opening the solution, write a full answer with steps, units and appropriate significant figures." },
  "diff.latihan.lanjut.c2": { id: "Untuk tiap soal hitungan, ubah satu besaran menjadi dua kali lipat: prediksi dulu bagaimana jawabannya berubah, lalu hitung untuk memastikan.", en: "For each calculation, double one quantity: predict how the answer changes, then calculate to confirm." },
  "diff.latihan.lanjut.c3": { id: "Coba soal tantangan tambahan di bawah (multi-langkah, gaya ujian).", en: "Try the extra challenge questions below (multi-step, exam style)." },
  "extra.title": { id: "Latihan Tambahan untuk Tingkat {{level}} (dibuat AI)", en: "Extra Practice for {{level}} Level (AI-generated)" },
  "extra.desc": { id: "Soal dibuat AI sesuai tingkat belajarmu memakai API key-mu. Pembahasan juga dari AI, jadi kalau ragu tanyakan ke gurumu.", en: "Questions are generated by AI to match your learning level, using your API key. Explanations are AI-written too, so ask your teacher if in doubt." },
  "extra.btn": { id: "Buat {{n}} soal tambahan", en: "Generate {{n}} extra questions" },
  "extra.btn.more": { id: "Buat {{n}} soal lagi", en: "Generate {{n}} more" },
  "extra.loading": { id: "AI sedang membuat soal...", en: "AI is writing questions..." },
  "extra.failed": { id: "Gagal membuat soal: {{err}}", en: "Couldn't generate questions: {{err}}" },
  "extra.needkey": { id: "Isi API key Gemini-mu dulu lewat tombol Pengaturan.", en: "Enter your Gemini API key first via the Settings button." },
  "extra.nobackend": { id: "Backend belum dikonfigurasi.", en: "Backend isn't configured." },
  "extra.q.label": { id: "Soal tambahan {{n}}", en: "Extra question {{n}}" },
  "extra.check": { id: "Cek jawabanku", en: "Check my answer" },
  "extra.pickone": { id: "Pilih satu jawaban dulu.", en: "Pick an answer first." },
  "extra.correct": { id: "Benar!", en: "Correct!" },
  "extra.wrong": { id: "Belum tepat. Jawaban yang benar: {{letter}}.", en: "Not quite. The correct answer is {{letter}}." },
  "extra.reveal": { id: "Lihat jawaban model", en: "Show model answer" },
  "extra.solution": { id: "Pembahasan / jawaban model:", en: "Explanation / model answer:" },
  "promptgen.leveldirective.dasar": { id: "\nKarena pengguna masih membangun konsep dasar: batasi kontrol maksimal 3 slider dengan nilai awal yang langsung menghasilkan tampilan bermakna, tampilkan rumus utama beserta arti tiap simbol di layar, dan tambahkan panel \"Apa yang harus diamati\" berisi 3 langkah pengamatan bernomor plus satu kalimat kesimpulan yang bisa dibuka lewat tombol \"Tunjukkan petunjuk\".\n", en: "\nBecause the user is still building the basics: limit controls to at most 3 sliders with starting values that immediately give a meaningful display, show the main formula with the meaning of each symbol on screen, and add an \"What to observe\" panel with 3 numbered observation steps plus a one-sentence conclusion revealed by a \"Show hint\" button.\n" },
  "promptgen.leveldirective.lanjut": { id: "\nKarena pengguna siap pengayaan: sediakan tugas \"Prediksi dulu\" (pengguna mengetik prediksi sebelum menjalankan simulasi lalu membandingkannya), tampilkan hasil numerik dengan angka penting yang wajar, sediakan tabel pencatatan data beberapa percobaan atau grafik yang bisa dianalisis gradiennya, dan tambahkan satu pertanyaan tantangan bergaya ujian Cambridge di bawah simulasi (misalnya kasus batas/ekstrem).\n", en: "\nBecause the user is ready for enrichment: provide a \"Predict first\" task (the user types a prediction before running the simulation and then compares), show numeric results with sensible significant figures, provide a data-logging table for several trials or a graph whose gradient can be analysed, and add one Cambridge exam-style challenge question below the simulation (e.g. a limiting/extreme case).\n" }
};
